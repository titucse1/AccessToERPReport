...
Class PackageModel extends CI_Model
{
	...
	function savePackage($Product_Package_Id='',$insertArray=array())//savePackage() is used for  Insert and Update IDCR_TBL_PRODUCT_PACKAGE.
	{
	...
	function getPackage($Product_Package_Id='')
	{
	...
	function getPackageSelectBox($required='',$currentPackage='')
	{	
	...
	function getPackageSingle($Product_Package_Id='')
	{
		$this->db->select(' Product_Package_Id, Product_Package_Name, Product_Package_Date, Product_Package_Amount,IDCR_TBL_PRODUCT_PACKAGE.Is_Void');
		$this->db->from('IDCR_TBL_PRODUCT_PACKAGE');
		$this->db->where('Product_Package_Id', $Product_Package_Id);	
