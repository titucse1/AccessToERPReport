...
<div class="row-fluid topWrapper">
   <div class="span12">
   <?php if($msg!='') echo $msg;?>
   <h3>Product Assigning: From Stock</h3>
   </div>
</div>
   ...
   <div class="span12 formWrapper">
            ...
            <form id="validation" class="bs-example bs-example-form" method="post" enctype="multipart/form-data" action="<?php echo base_url()."assign/submit/";?>">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" id="productName" name="Product_Info" maxlength="20" class="form-control" placeholder="No Product Selected"/>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" id="personName" name="Person_Info" maxlength="20" class="form-control" placeholder="No Person Selected"/>
